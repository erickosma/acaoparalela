<section id="feature" class="mx-auto w-100 mt-5 bg-light justify-content-center mb-5">
    ...
    <div class="d-lg-flex justify-content-center text-center align-content-center bg-white-ac" >
    ...
    <div class="d-lg-flex justify-content-center text-center align-content-center bg-white-ac" >
        <div class="card-deck  text-left">
            <div class="card card-ac">
                <img class="card-img-top" src="https://picsum.photos/200/205" alt="Card image cap">
                <a href="#">
                    <div class="card-body">
                        <h4 class="card-title">Card title</h4>
                        <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            ...
            <div class="card card-ac">
                <img class="card-img-top" src="https://picsum.photos/200/211" alt="Card image cap">
                <a href="#">
                    <div class="card-body">
                        <h4 class="card-title">Card title</h4>
                        <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
